...
public class demo4 {
    static class Songs implements Serializable {
    ...
    public  static void main(String[] args) throws FileNotFoundException {
        ...
        List<Song> collect = songList.stream().filter(genre -> "Rock".equals(genre.getGenre())).collect(Collectors.toList());
        System.out.println(collect);
        songList.stream().map(Song::getGenre).forEach(System.out::println);
        songList list = new songList();
        try {
            FileOutputStream fos = new FileOutputStream("/Users/duqiu/Desktop/java/javapro/java1/src/com/java/Stream/java.txt");
        ...
        try {
            FileInputStream fis = new FileInputStream("/Users/duqiu/Desktop/java/javapro/java1/src/com/java/Stream/java.txt");
